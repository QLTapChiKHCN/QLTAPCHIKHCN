      ...
      <div class="row g-4">
        ...
        <article class="col-md-10">
          <div class="main-content">
            <form action="{{ route('submitArticle') }}" accept-charset="UTF-8" method="POST" enctype="multipart/form-data">
              @csrf
              ...
              <table class="table">
                ...
                <tbody id="authorList">
                    <tr>
                      <td><input type="text" name="ten_tac_gia[]" class="form-control" value="{{ $user->HoTen }}" required></td>
                      <td><input type="email" name="email_tac_gia[]" class="form-control" value="{{ $user->Email }}" required></td>
                      <td><input type="text" name="dia_chi_tac_gia[]" class="form-control" value="{{ $user->DiaChi }}"></td>
                      <td><input type="text" name="sdt_tac_gia[]" class="form-control" value="{{ $user->SoDienThoai }}" pattern="^\d{10}$" title="Số điện thoại phải có 10 số" required></td>
                      <td>
                      ...
                      <td>
                        <button type="button" class="btn btn-primary" id="addCoAuthorBtn">Thêm đồng tác giả</button>
                      </td>
                    </tr>
                  </tbody>
              ...
              <div class="row g-4">
                <div class="col-12">
                    ...
                    <input type="text" name="tieu_de" class="form-control" placeholder="Nhập tiêu đề bài báo" required>
                  </div>
                <div class="col-12">
              ...
              <form id="coAuthorForm">
                ...
                <div id="authorInfoFields" style="display: none;">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="coAuthorPhone" pattern="^\d{10}$" title="Số điện thoại phải có 10 số" required>
                  </div>
                  <div class="mb-3">
                    <label for="coAuthorAddress" class="form-label">Địa chỉ</label>
                    <input type="text" class="form-control" id="coAuthorAddress" required>
                  </div>
                  <button type="button" class="btn btn-primary" id="submitCoAuthor">Thêm đồng tác giả</button>
                </div>
              </form>
            </div>
          </div>
